#!/usr/bin/env python3
"""
Simple test for shrimp farming weather impact analysis method
"""
import sys
import os
...
def test_shrimp_impact_method():
    """Test the shrimp farming weather impact analysis method directly"""

    # Create predictor instance (without loading heavy ML models)
